...
Al finalizar el ciclo de desarrollo correspondiente a esta entrega —centrado en la implementación del backend de FullTank bajo Domain-Driven Design y su integración real con la Web Application desarrollada en sprints previos—, el equipo contrastó los cuatro Hypothesis Statements planteados en la sección 1.2.2.3 con la evidencia obtenida durante las entrevistas de validación y el desarrollo técnico de los Sprints 2, 3 y 4.

**Hypothesis Statement 01 — Centralización de pedidos y reducción de errores de coordinación:**

Se planteó que centralizar los pedidos reduciría drásticamente el margen de error por problemas de coordinación entre solicitantes y proveedores, con éxito medible como un 70% de pedidos confirmados sin correcciones posteriores tras tres meses de uso. La entrevista con Jesús Ponce (Agroconjuic, segmento comprador) respalda cualitativamente esta hipótesis: destacó la facilidad de controlar el consumo de combustible de todas sus maquinarias desde un solo lugar, calificando la experiencia como "eficiente" y afirmando que usaría la plataforma sin dudarlo. Sin embargo, dado que la validación se realizó mediante un piloto de entrevistas y no sobre una operación real de tres meses, el umbral cuantitativo del 70% aún no puede confirmarse ni refutarse; queda como métrica pendiente de medición una vez la plataforma esté en producción con datos reales sostenidos en el tiempo, ahora viable gracias a que el backend expone servicios de pedidos persistidos en base de datos real (TS-04, TS-05, TS-13, TS-14).

**Hypothesis Statement 02 — Herramientas de seguimiento y satisfacción del solicitante:**

Se propuso que ofrecer más herramientas de control y seguimiento mejoraría la satisfacción de los clientes solicitantes, con éxito medido como una reducción del 30% en llamadas de seguimiento. Jesús Ponce valoró especialmente los reportes visuales mensuales de gastos y consumo como la funcionalidad de mayor valor para su empresa, lo cual es consistente con la hipótesis. No obstante, la reducción de llamadas de seguimiento es una métrica operativa que depende de comparar el comportamiento del cliente antes y después de adoptar la plataforma en un entorno real, algo que no pudo observarse en una entrevista puntual. La hipótesis se mantiene parcialmente validada a nivel de percepción de valor, pero pendiente de confirmación cuantitativa.

**Hypothesis Statement 03 — Optimización del proceso de gestión para proveedores:**

Se planteó que la plataforma permitiría a los proveedores optimizar la gestión de pedidos y reducir el tiempo entre confirmación y entrega, con éxito medido como una reducción del 20% en ese tiempo promedio. La entrevista con Jainer Gutiérrez (Petro Cajamarca, segmento proveedor) confirma la dirección de esta hipótesis: indicó que la plataforma le permitiría centralizar procesos que hoy realiza mediante WhatsApp y llamadas telefónicas, valorando especialmente el control sobre inventario, pedidos y despachos como una reducción considerable del tiempo invertido en sus operaciones diarias. Esta percepción se ve reforzada por la implementación real de los servicios de logística (TS-15 a TS-19: solicitudes, entregas, conductores y vehículos), que en el Sprint 3 pasaron de ser simulados en json-server a estar soportados por persistencia real con JPA. Aun así, el 20% de reducción de tiempo requiere datos operativos de uso continuo que todavía no existen.

**Hypothesis Statement 04 — Notificaciones automáticas y reducción de operadores comerciales:**

Se propuso que las notificaciones automáticas sobre el estado de los pedidos reducirían la necesidad de operadores comerciales de alta disponibilidad, con éxito medido como una disminución del 40% en solicitudes de información y del 60% en el tiempo promedio de atención tras el primer trimestre. Jainer Gutiérrez sugirió como mejora una visualización más clara del seguimiento de entregas en tiempo real, lo cual indica que, si bien el sistema de notificaciones (TS-26) fue implementado y documentado en Swagger durante el Sprint 3, la experiencia de notificación en tiempo real aún no alcanza el nivel de claridad necesario para sustituir por completo la comunicación informal (llamadas, WhatsApp) que hoy usan los proveedores. Esta hipótesis queda parcialmente refutada en su forma actual: la automatización reduce dependencia de coordinación manual, pero requiere mejoras de visibilidad antes de que pueda esperarse una reducción del 60% en tiempo de atención.

**Conclusión general:**

Las cuatro hipótesis muestran una dirección de validación positiva a nivel cualitativo, respaldada tanto por las entrevistas de los dos segmentos (comprador y proveedor) como por la disponibilidad real de los servicios backend que antes solo existían como datos simulados. Sin embargo, ninguno de los cuatro umbrales cuantitativos (70%, 30%, 20%, 40%/60%) puede darse por confirmado con la evidencia disponible, ya que esta proviene de un piloto de entrevistas y no de un periodo de uso productivo sostenido. La conexión real entre backend y frontend lograda en los Sprints 3 y 4 constituye la base necesaria para iniciar la medición de estas métricas en una futura fase de operación real de la plataforma.
...
URL de la Landing Page: [https://primefuel.github.io/FullTank_LandingPage/](https://primefuel.github.io/FullTank_LandingPage/)

URL del Swagger: https://prime-fuel-backend.onrender.com/swagger-ui/index.html

URL del frontend: https://frontend-dgwsg79ja-bralexcds-projects.vercel.app/iam
